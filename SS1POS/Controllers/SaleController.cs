...
namespace SS1POS.Controllers
{
    public class SaleController : Controller
    {
        ...
        public async Task<JsonResult> ScanBarcode(string barcode)
            => Json(await _context.Product.FirstOrDefaultAsync(x => x.Barcode.Equals(barcode)));
        // GET: Sale/Details/5
        ...
        public async Task<IActionResult> Create([Bind("SaleId,CustomerId,InvoiceNumber,IssueDate,Total,Discount,GrandTotal")] Sale sale)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("SaleId,CustomerId,InvoiceNumber,IssueDate,Total,Discount,GrandTotal")] Sale sale)
        {
            if (id != sale.SaleId)
            {
                return NotFound();
